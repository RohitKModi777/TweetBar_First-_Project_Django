"""
Django settings for chaiheadq project (Production Ready).
...
# Add your deployed domain or Vercel URL
ALLOWED_HOSTS = ['https://tweet-bar-first-project-django.vercel.app', '127.0.0.1']
...
# ADDITIONAL SETTINGS
# ----------------------------
# Example: Email backend or other production settings can be added here
